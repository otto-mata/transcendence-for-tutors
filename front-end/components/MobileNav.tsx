...
export default function MobileNav() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-80 bg-white dark:bg-gray-900 shadow-2xl z-40 transform transition-transform duration-300 ease-in-out lg:hidden ${
...
function NavLink({
  ...
  return (
    ...
    >
      <div
        className={`${active ? "text-blue-500" : "text-gray-600 group-hover:text-blue-500"} transition-colors`}
      >
        {icon}
      </div>
